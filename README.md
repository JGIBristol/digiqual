...
```bash
# To install the latest stable release (v0.10.1):

uv add "digiqual @ git+https://github.com/JGIBristol/digiqual.git@v0.10.1"
...
```bash
uv pip install "git+https://github.com/JGIBristol/digiqual.git@v0.10.1"
```
...
```bash
pip install "git+https://github.com/JGIBristol/digiqual.git@v0.10.1"
```
