...
```bash
# To install the latest stable release (v0.4.0):

uv add "digiqual @ git+https://github.com/JGIBristol/digiqual.git@v0.4.0"
...
```bash
uv pip install "git+https://github.com/JGIBristol/digiqual.git@v0.4.0"
```
...
```bash
pip install "git+https://github.com/JGIBristol/digiqual.git@v0.4.0"
```
