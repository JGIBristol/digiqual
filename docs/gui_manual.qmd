...
1. **Select Modality:** Choose between standard **1D Marginal PoD** or **Multi-Dimensional PoD**.
2. **Variable Designation:** Select your primary Parameter of Interest (PoI). Any remaining input variables are automatically assigned as Nuisance Parameters and mathematically marginalised out via Monte Carlo Integration.
3. **Set Threshold:** Define the critical threshold (e.g., a detection limit of `18.0`).
4. **Generate Outcomes:** The system automatically identifies the best predictive polynomial structure, infers error distribution, and generates bootstrap confidence intervals.
5. **Interactive Mapping:** It renders two interactive plots side-by-side:
