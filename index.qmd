...
description: "A Python-based implementation of the Generalised a-vs-â framework for Model-Assisted Probability of Detection (MAPOD) studies."
page-layout: full
---
...
`digiqual` is a specialised statistical library developed for Non-Destructive Evaluation (NDE) professionals. It provides a rigorous framework for conducting Model-Assisted Probability of Detection (MAPOD) studies, utilising the **Generalised $\hat{a}$-versus-$a$ Method**.
...
::: {.g-col-12 .g-col-md-4}
### 🖥️ Full GUI Tool
Specialised Graphical User Interface that contains the full suite of digiqual tools and downloadable reports.
:::
